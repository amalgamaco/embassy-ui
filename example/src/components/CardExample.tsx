...
import {
	...
	CardMedia, IconButton, Image, Text, UIKitIcon, VStack
...
const CardExample = () => (
	<VStack marginBottom="5">
		...
		<Card>
			...
			<CardActions>
				<Button variant="primary" width={120} py="2.5">Action 1</Button>
				<Button variant="secondary" width={120} py="2.5">Action 2</Button>
			</CardActions>
		</Card>
	</VStack>
);
